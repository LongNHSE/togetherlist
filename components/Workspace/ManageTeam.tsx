  ...
  return (
    <div>
      ...
      <div className="w-9/12 border-b-2 border-slate-400 mt-5">
        <p className="text-xl font-semibold ">Invite member to join your Workspace</p>
        <div className="flex align-middle">
        <Input className="w-72 h-10 mt-3 mb-5 border border-dark_brown" placeholder="Enter member email"/>
        <Button className="w-20 h-10 mt-3 mb-5 ml-2 bg-sky-500 hover:bg-sky-600">Invite</Button>
        </div>
      ...
      <div className="w-9/12">
        {teamMembers.map((member, index) => (
          <div key={index} className="hover:bg-slate-100 text-sm border-b-2 border-slate-400 flex justify-between items-center p-2">
            ...
            <div className="flex justify-end space-x-4">
              ...
              <div className="py-1 px-3 rounded text-white bg-stone-500  hover:bg-stone-600">{member.role}</div>
              <div>
