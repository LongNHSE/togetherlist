...
export default function Container({ task1 }: { task: TaskType }) {
  const taskTest = {
    _id: '1',
    name: 'Task Name',
    schedule: {
  ...
  const [task, setTask] = React.useState(taskTest);
  return (
    <div className="m-24 w-full overflow-y-auto flex flex-row">
